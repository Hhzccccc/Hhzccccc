...
public class CreportServiceImpl implements CreportService {
    ...
    @Override
    public List<ReportVo> sel1(ReportVo reportVo) { return creportMapper.sel1(reportVo); }

    @Override
    public List<ReportVo> sel2(ReportVo reportVo) { return creportMapper.sel2(reportVo); }
    ...
    @Override
    public List<ReportVo> selPatientById(Integer reportId) {
        return creportMapper.selPatientById(reportId);
    }
